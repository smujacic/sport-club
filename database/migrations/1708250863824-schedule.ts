...
export class Schedule1708250863824 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "schedule" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "duration" integer, "dayOfWeek" "public"."schedule_dayofweek_enum" NOT NULL, CONSTRAINT "PK_1c05e42aec7371641193e180046" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "sport-class" ADD CONSTRAINT "FK_6aae1a292ad24f725c6fec89f7a" FOREIGN KEY ("scheduleId") REFERENCES "schedule"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
